...
fetch('https://raw.githubusercontent.com/FreeCodeCamp/ProjectReferenceData/master/GDP-data.json')
  ...
  var marginTop = 10;                     //Parameters can vary
  var marginBottom = 25;
  var marginLeft = 60; 
  var marginRight = 15;
...
var toolTip = d3.select('.chart') //In case this fails, toggle visibility
    .append('div')
    .attr('class', 'tooltip')
...
bar.append('g')
    ...
    .on('mouseover', function(d) {
      ...
      toolTip
        .attr('style','left:'+ posX +'px;top:'+ posY +'px; visibility: visible;') //In case this fails, toggle visibility
